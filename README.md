...
Build smart contracts to automate some companies' finances to make everyone's lives easier, increase transparency, and to make accounting and auditing practically automatic!

We will create a few `ProfitSplitter` contracts. These contracts will do several things:
...
Using the contract file, within the `deposit` function, perform the following:
